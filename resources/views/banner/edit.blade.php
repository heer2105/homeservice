            ...
            <div class="col-lg-8 col-md-6 d-flex flex-column  ">
              ...
              <div class="card mb-3 ms-5">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="{{route('banner.update',$banner->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="b_name" value="{{$banner->b_name}}"class="form-control" id="yourUsername" placeholder="Enter Service Name" required>
