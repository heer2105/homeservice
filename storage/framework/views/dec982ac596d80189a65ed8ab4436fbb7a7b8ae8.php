...
<body>
	<div class="loader">
	  <div class="spinner">
		<img src="<?php echo e(asset('assets')); ?>/images/loader.gif" alt=""/>
	  </div> 
	</div>
    <!-- Main Body -->
    <div class="page-wrapper">
                        ...
                        <div class="user-info-wrapper header-links">
                          ...
                          <a href="javascript:void(0);" class="user-info">
                              ...
                              <div class="avatar avatar-xl">
                                ...
                                <img src="<?php echo e(asset($avatar)); ?> " class="user-img" onclick="window.location.href='/myprofile'" style="cursor: pointer;" alt="User Avatar">
      ...
      <button class="logoutButton logoutButton--dark" id="logoutbtn">
        ...
        <aside class="sidebar-wrapper">
			<div class="logo-wrapper">
				<a href="index.html" class="admin-logo">
					...
					<img src="<?php echo e(asset('assets')); ?>/images/Elite cleaners logo.png" alt="" class="sp_logo" ">
        ...
        <div class="page-wrapper">
            ...
            <?php /**PATH /var/www/homeservice/resources/views/header.blade.php ENDPATH**/ ?>