            ...
            <div class="col-lg-8 col-md-6 d-flex flex-column  ">
              ...
              <div class="card mb-3 ms-5">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="<?php echo e(route('banner.update',$banner->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="b_name" value="<?php echo e($banner->b_name); ?>"class="form-control" id="yourUsername" placeholder="Enter Service Name" required>
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/homeservice/resources/views/banner/edit.blade.php ENDPATH**/ ?>