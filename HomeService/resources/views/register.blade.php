            ...
            <div class="splash-auth-content">
                <form method="POST" action="/register" class="form">
                    ...
                    <div class="splash-auth-form">
                        <div class="splash-auth-feilds mb-30">
                            <input type="text" placeholder="Enter Name" class="splash-input" id="username"
                                name="username" />
                        ...
                        <div class="splash-auth-feilds mb-30">
                            <input type="email" placeholder="Enter Email" class="splash-input" id="email"
                                name="email" />
                            <div class="splash-auth-icon">
                ...
                function togglePassword1(inputId, eyeId) {
                    ...
                    if (passwordField.type === "password") {
                        ...
                        <div class="splash-auth-feilds mb-30">
                            <input type="password" placeholder="Password" class="splash-input" id="password"
                                name="password" />
                            <div class="splash-auth-icon">
                                <!-- Existing Lock Icon -->
                            ...
                            <!-- Eye Icon for Password Visibility -->
                            <div class="eye-icon" onclick="togglePassword('password', 'eyeIcon1')">
                                <svg id="eyeIcon1" xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
                                    viewBox="0 0 24 24">
                                    <path fill="currentColor"
                                        d="M12 4.5C7.5 4.5 3.73 7.61 2 12c1.73 4.39 5.5 7.5 10 7.5s8.27-3.11 10-7.5c-1.73-4.39-5.5-7.5-10-7.5zm0 12c-2.49 0-4.5-2.01-4.5-4.5S9.51 7.5 12 7.5s4.5 2.01 4.5 4.5-2.01 4.5-4.5 4.5z" />
                                </svg>
                            </div>
                            <span class="text-danger">
                                @error('password')
                        ...
                        <div class="splash-auth-feilds mb-30">
                            <input type="password" placeholder="Confirm Password" class="splash-input"
                            ...
                            <div class="eye-icon" onclick="togglePassword('cpassword', 'eyeIcon2')">
                                <svg id="eyeIcon2" xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
                                    viewBox="0 0 24 24">
                                    <path fill="currentColor"
                                        d="M12 4.5C7.5 4.5 3.73 7.61 2 12c1.73 4.39 5.5 7.5 10 7.5s8.27-3.11 10-7.5c-1.73-4.39-5.5-7.5-10-7.5zm0 12c-2.49 0-4.5-2.01-4.5-4.5S9.51 7.5 12 7.5s4.5 2.01 4.5 4.5-2.01 4.5-4.5 4.5z" />
                                </svg>
                        ...
                        <script>
                            function togglePassword(inputId, eyeId) {
                                ...
                                if (passwordField.type === "password") {
                                    passwordField.type = "text";
                                    eyeIcon.innerHTML =
                                        '<path fill="currentColor" d="M12 4.5C7.5 4.5 3.73 7.61 2 12c1.73 4.39 5.5 7.5 10 7.5s8.27-3.11 10-7.5c-1.73-4.39-5.5-7.5-10-7.5zm0 12c-2.49 0-4.5-2.01-4.5-4.5S9.51 7.5 12 7.5s4.5 2.01 4.5 4.5-2.01 4.5-4.5 4.5zM4.07 12C5.92 9.61 8.85 8 12 8s6.08 1.61 7.93 4c-1.85 2.39-4.78 4-7.93 4s-6.08-1.61-7.93-4zM12 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/>';
                                } else {
                                    passwordField.type = "password";
                                    eyeIcon.innerHTML =
                                        '<path fill="currentColor" d="M12 4.5C7.5 4.5 3.73 7.61 2 12c1.73 4.39 5.5 7.5 10 7.5s8.27-3.11 10-7.5c-1.73-4.39-5.5-7.5-10-7.5zm0 12c-2.49 0-4.5-2.01-4.5-4.5S9.51 7.5 12 7.5s4.5 2.01 4.5 4.5-2.01 4.5-4.5 4.5z"/>';
                        ...
                        <div class="splash-auth-feilds mb-30">
                            <input type="tel" placeholder="Enter Mobile Number" class="splash-input"
                                id="mobile_no" name="mobile_no" pattern="[0-9]{10}" maxlength="10" />
                            <div class="splash-auth-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="16px" height="16px">
                                    <path fill-rule="evenodd" fill="currentColor"
                        ...
                        <div class="splash-auth-feilds mb-30 position-relative">
                            <!-- Gender Dropdown -->
                            <select name="gender" class="splash-input" id="gender"
                                style="width: 100%; padding: 12px 40px 12px 45px; font-size: 14px; border: 1px solid #ccc; border-radius: 8px; background: #fff; color: #999; appearance: none; outline: none;">
                            ...
                            <div class="splash-auth-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
                                    ...
                                    <path
                                        d="M19 2h-4v2h1.6l-2.5 2.5A5 5 0 1 0 12 17v3h-2v2h6v-2h-2v-3a5 5 0 0 0 2.9-8.5L18 5.6V7h2V3a1 1 0 0 0-1-1ZM8 14a3 3 0 1 1 3-3 3 3 0 0 1-3 3Z" />
                                </svg>
                            </div>
                        ...
                        <div class="splash-auth-feilds mb-30">
                            <select id="role" name="role" class="splash-input"
                                style="width: 100%; padding: 12px 40px 12px 45px; font-size: 14px; border: 1px solid #ccc; border-radius: 8px; background: #fff; color: #999; appearance: none; outline: none;">
                        ...
                        <div class="splash-auth-feilds mb-30">
                            <select id="sec_que" name="sec_que" class="splash-input"
                                style="width: 100%; padding: 12px 40px 12px 45px; font-size: 14px; border: 1px solid #ccc; border-radius: 8px; background: #fff; color: #999; appearance: none; outline: none;">
                        ...
                        <div class="splash-auth-feilds mb-30">
                            ...
                            <input type="text" id="sec_ans" name="sec_ans" class="splash-input"
                        ...
                        <button type="button" class="effect-btn btn btn-secondary mt-2 mr-2 icon-sm"><i
                                class="fab fa-facebook-f"></i></button>
                        <button type="button" class="effect-btn btn btn-success mt-2 mr-2 icon-sm"><i
                                class="fab fa-linkedin-in"></i></button>
                        <button type="button" class="effect-btn btn btn-danger mt-2 mr-2 icon-sm"><i
                                class="fab fa-instagram"></i></button>
                        <button type="button" class="effect-btn btn btn-info mt-2 mr-2 icon-sm"><i
                                class="fab fa-pinterest-p"></i></button>
                        <button type="button" class="effect-btn btn btn-dark mt-2 mr-2 icon-sm"><i
        ...
        (function() {
            function c() {
                ...
                if (b) {
                    ...
                    d.innerHTML =
                        "window.__CF$cv$params={r:'8f9111abba27e161',t:'MTczNTM4Mzg2MS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='../../../../cdn-cgi/challenge-platform/h/b/scripts/jsd/787bc399e22f/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";
