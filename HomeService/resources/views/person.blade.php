                        ...
                        {{-- <td>
                            <div class="dropdown ">
                                ...
                                <ul class="dropdown-menu custom-dropdown  ">
                                    <li>
                                        <a class="dropdown-item bg-primary text-white" href="{{ route('customer.edit', $item->_id) }}">
                                            <i class="fa fa-edit"></i> Edit
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item bg-success text-white" href="{{ route('customer.show', $item->_id) }}">
                                            <i class="fa fa-edit"></i> Show
                                        </a>
                                    </li> --}}
                                    {{-- <li>
                                        <form class="d-inline" onsubmit="confirmDelete(event)" action="{{ route('customer.destroy', $item->_id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
