...
<body>
    ...
    <div class="page-wrapper">
                        ...
                        <div class="user-info-wrapper header-links">
                            ...
                            <a href="javascript:void(0);" class="user-info">
                                ...
                                <div class="avatar avatar-xl">
                                    ...
                                    <img src="{{ asset($avatar) }} " class="user-img"
                                        onclick="window.location.href='/myprofile'" style="cursor: pointer;"
                                        alt="User Avatar">
     ...
     {{-- <img src="{{asset('assets')}}/images/Elite cleaners logo.png" alt="" class="sp_mini_logo"> --}}
            ...
            <div class="side-menu-wrap mt-3">
                <ul class="main-menu">
                    <li>
                        <a href="/" class="active">
                            <span class="icon-menu feather-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="
                        M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                ...
                <li>
                    <a href="/coupon">
                        <span class="icon-menu feather-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-ticket nav-icon">
                                <path
                                    d="M3 9V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v4a2 2 0 0 0 0 6v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4a2 2 0 0 0 0-6z">
                                </path>
                ...
                <li>
                    <a href="/combo">
                        <span class="icon-menu feather-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-box nav-icon">
                                <path
