...
{{-- <div class="splash-footer-btm">
  <p>Copyright 2023 © EliteCleaners All Rights Reserved.</p>
</div> --}}
...
<script src="{{asset('assets')}}/js/apexchart/apexcharts.min.js"></script>
<script src="{{asset('assets')}}/js/apexchart/control-chart-apexcharts.js"></script>
<!-- Page Specific -->
