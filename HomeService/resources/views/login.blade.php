                ...
                <form class="form" method="POST" action="login">
                    ...
                    <div class="splash-auth-form">
                        <div class="splash-auth-feilds mb-30">
                            <input type="text" placeholder="Username " class="splash-input" name="username"
                                id="username" />
                        ...
                        <div class="splash-auth-feilds">
                            <input type="password" placeholder="Password" class="splash-input" name="password"
                                id="password" />

                            <!-- Original Password Icon -->
                            <div class="splash-auth-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 482.8 482.8" width="20px"
                                    height="20px">
                                    <path
        ...
        (function() {
            function c() {
                ...
                if (b) {
                    ...
                    d.innerHTML =
                        "window.__CF$cv$params={r:'8f91114d28ff70f2',t:'MTczNTM4Mzg0Ni4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='../../../../cdn-cgi/challenge-platform/h/b/scripts/jsd/787bc399e22f/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";
